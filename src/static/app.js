  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty !== "all") {
        // If an activity doesn't have a difficulty field, it's considered "all levels"
        // So it should only appear when "all" is selected, not when a specific difficulty is selected
